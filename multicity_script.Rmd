...
litter <- read.csv('https://raw.githubusercontent.com/TrevorKap/MUSA810-Marine-Pollution/main/Data/mdt-dataSemarang.csv')
...
chen_bdry <- st_read('https://github.com/TrevorKap/MUSA810-Marine-Pollution/raw/main/Data/Semarang.kml')
chen_bdry <- st_set_crs(chen_bdry, 4326)%>%st_transform('EPSG:23849')
temp_bd <- st_read('https://github.com/TrevorKap/MUSA810-Marine-Pollution/raw/main/Data/Semarang.kml')
...
pop_result <- pop_process(temp_point, temp_fish, 23849) # summary the population result
