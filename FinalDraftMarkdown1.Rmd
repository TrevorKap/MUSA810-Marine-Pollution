...
<div style="text-align:center;">
  <img src="partners.png" alt="Image Source: Ocean Conservancy" width="450"/>
  <img src="mumbai.png" alt="Image Source: The Independent" width="350"/>
  <br><br>
...
Additionally, we also hypothesized population density as having a major influence on our model. We used [Data for Good at Meta's](https://data.humdata.org/organization/meta?q=population+density&sort=if%28gt%28last_modified%2Creview_date%29%2Clast_modified%2Creview_date) global high resolution population density maps. This global dataset works as a proxy for population density.
