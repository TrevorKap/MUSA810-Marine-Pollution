...
# Train the model
model <- train(count ~ ., data = train%>%dplyr::select(-c('city','uniqueID')), method = "lm",family = "quasi",trControl = train_control)
...
```{r}
rst_total <- rst_total %>%
  mutate(Prediction = 0.6*Pre_rf + 0.4*Pre_lr)
rst_total <- risk_level(rst_total,'kmeans')

city_viz('Chennai',rst_total,'rf_model')
...
### 4 variables tree
```{r}
grid <- expand.grid(mtry = c(4,5,6,7,8))
rf_model <- train(count ~ ., data = train, method = "rf", trControl = train_control, tuneGrid = grid)

df_rf_rst_2 <- net_total%>%mutate(Prediction = predict(rf_model,net_total))
df_rf_rst_temp <- st_drop_geometry(risk_level(df_rf_rst_2,'kmeans')) %>%dplyr::select(Risk_Category)
df_rf_rst_2 <- cbind(df_rf_rst_2,df_rf_rst_temp)
```

```{r}
city_viz('Chennai',df_rf_rst_2,'rf_model')
city_viz('Bangkok',df_rf_rst_2,'rf_model')
city_viz('Can_Tho',df_rf_rst_2,'rf_model')
city_viz('Melaka',df_rf_rst_2,'rf_model')
city_viz('Mumbai',df_rf_rst_2,'rf_model')
city_viz('Panama_City',df_rf_rst_2,'rf_model')
city_viz('Pune',df_rf_rst_2,'rf_model')
city_viz('Salvador',df_rf_rst_2,'rf_model')
city_viz('Santa_Fe',df_rf_rst_2,'rf_model')
city_viz('Santiago',df_rf_rst_2,'rf_model')
city_viz('Semarang',df_rf_rst_2,'rf_model')
city_viz('Surat',df_rf_rst_2,'rf_model')
```
...
df_rf_rst_3 <- net_total%>%mutate(Prediction = predict(rf_model,net_total))
df_rf_rst_temp <- st_drop_geometry(risk_level(df_rf_rst_3,'kmeans')) %>%dplyr::select(Risk_Category)
df_rf_rst_3 <- cbind(df_rf_rst_3,df_rf_rst_temp)
```

```{r}
city_viz('Chennai',df_rf_rst_3,'rf_model')
city_viz('Bangkok',df_rf_rst_3,'rf_model')
city_viz('Can_Tho',df_rf_rst_3,'rf_model')
city_viz('Melaka',df_rf_rst_3,'rf_model')
city_viz('Mumbai',df_rf_rst_3,'rf_model')
city_viz('Panama_City',df_rf_rst_3,'rf_model')
city_viz('Pune',df_rf_rst_3,'rf_model')
city_viz('Salvador',df_rf_rst_3,'rf_model')
city_viz('Santa_Fe',df_rf_rst_3,'rf_model')
city_viz('Santiago',df_rf_rst_3,'rf_model')
city_viz('Semarang',df_rf_rst_3,'rf_model')
city_viz('Surat',df_rf_rst_3,'rf_model')
```
...
df_rf_rst_4 <- net_total%>%mutate(Prediction = predict(rf_model,net_total))
df_rf_rst_temp <- st_drop_geometry(risk_level(df_rf_rst_4,'kmeans')) %>%dplyr::select(Risk_Category)
df_rf_rst_4 <- cbind(df_rf_rst_4,df_rf_rst_temp)
```

```{r}
city_viz('Chennai',df_rf_rst_4,'rf_model')
city_viz('Bangkok',df_rf_rst_4,'rf_model')
city_viz('Can_Tho',df_rf_rst_4,'rf_model')
city_viz('Melaka',df_rf_rst_4,'rf_model')
city_viz('Mumbai',df_rf_rst_4,'rf_model')
city_viz('Panama_City',df_rf_rst_4,'rf_model')
city_viz('Pune',df_rf_rst_4,'rf_model')
city_viz('Salvador',df_rf_rst_4,'rf_model')
city_viz('Santa_Fe',df_rf_rst_4,'rf_model')
city_viz('Santiago',df_rf_rst_4,'rf_model')
city_viz('Semarang',df_rf_rst_4,'rf_model')
city_viz('Surat',df_rf_rst_4,'rf_model')
```

### 12 variables tree
```{r}
grid <- expand.grid(mtry = c(2,3,8,9,10,15,16,17))
rf_model <- train(count ~ ., data = train, method = "rf", trControl = train_control, tuneGrid = grid)

df_rf_rst_5 <- net_total%>%mutate(Prediction = predict(rf_model,net_total))
df_rf_rst_temp <- st_drop_geometry(risk_level(df_rf_rst_5,'kmeans')) %>%dplyr::select(Risk_Category)
df_rf_rst_5 <- cbind(df_rf_rst_5,df_rf_rst_temp)
```

```{r}
city_viz('Chennai',df_rf_rst_5,'rf_model')
city_viz('Bangkok',df_rf_rst_5,'rf_model')
city_viz('Can_Tho',df_rf_rst_5,'rf_model')
city_viz('Melaka',df_rf_rst_5,'rf_model')
city_viz('Mumbai',df_rf_rst_5,'rf_model')
city_viz('Panama_City',df_rf_rst_5,'rf_model')
city_viz('Pune',df_rf_rst_5,'rf_model')
city_viz('Salvador',df_rf_rst_5,'rf_model')
city_viz('Santa_Fe',df_rf_rst_5,'rf_model')
city_viz('Santiago',df_rf_rst_5,'rf_model')
city_viz('Semarang',df_rf_rst_5,'rf_model')
city_viz('Surat',df_rf_rst_5,'rf_model')
```

### model comparison
```{r}
grid.arrange(city_viz('Chennai',df_rf_rst_5,'rf_model'),
             city_viz('Chennai',df_rf_rst,'rf_model'), # 3 variables
             city_viz('Chennai',df_rf_rst_2,'rf_model'), # 4 variables
             city_viz('Chennai',df_rf_rst_3,'rf_model'), # 8 variables
             city_viz('Chennai',df_rf_rst_4,'rf_model'),nrow=2) # 12 variables

```

```{r}
city_viz('Surat',df_rf_rst,'rf_model') # 3 variables
city_viz('Surat',df_rf_rst_2,'rf_model') # 4 variables
city_viz('Surat',df_rf_rst_3,'rf_model') # 8 variables
```

```{r}
city_viz('Santiago',df_rf_rst,'rf_model') # 3 variables
city_viz('Santiago',df_rf_rst_2,'rf_model') # 4 variables
city_viz('Santiago',df_rf_rst_3,'rf_model') # 8 variables
```
