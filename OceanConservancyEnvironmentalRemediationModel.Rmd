...
```{r trans visualization, message=FALSE, warning=FALSE}
...
do.call(grid.arrange,c(varList, ncol = 4, top = "Local Morans I Statistics"))
```
...
ggplot() +
    ...
    labs(title="Litter Assessment Predictions, Chennai",
         subtitle="") +
    mapTheme(title_size = 14)
```
...
We will be continuing our modeling process by attempting different kinds of models, including a random forest model. These models will be completed and properly evaluated in the future.
