...
mumb_bdry <- st_read('https://github.com/TrevorKap/MUSA810-Marine-Pollution/raw/main/Data/Bangkok.kml')
...
india <- getbb(place_name = "Bangkok", format_out = "polygon") # not used 
bb_df <- getbb(place_name = "Bangkok, Thailand", format_out = "data.frame") # get chennai boundary
bdry <- bb_df$boundingbox # extract the geoemtry part
bdry
mumb_bd <- c(100.6535089, 13.9124938, 100.3335089, 13.5924938) # just a record
# 4, 2, 3, 1
```
