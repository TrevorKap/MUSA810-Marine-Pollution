...
```{r}
# load litter data
litter <- read.csv('https://raw.githubusercontent.com/TrevorKap/MUSA810-Marine-Pollution/main/Data/mdt-dataPanama_City.csv')
...
mumb_bdry <- st_read('https://github.com/TrevorKap/MUSA810-Marine-Pollution/raw/main/Data/Panama_City.kml')
...
india <- getbb(place_name = "Panama", format_out = "polygon") # not used 
...
bdry
mumb_bd <- c(-79.3741802, 9.3314493, -79.6941802, -8.5114493) # just a record
# 4, 2, 3, 1
```
