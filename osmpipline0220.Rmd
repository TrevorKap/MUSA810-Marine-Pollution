...
subtitle: "Exploratory Analysis and Preliminary Model Building"
author: "University of Pennsylvania MUSA Practicum: Trevor Kapuvari, Shreya Bansal, Tianxiao Chen, Stephanie Cheng, Xiaofan Liu"
date: "2024-02-27"
output: 
  html_document:
    toc: true
...
```{r, warning=FALSE, message=FALSE, error=FALSE, include=FALSE, cache=TRUE}
...
```{r function build, results='hide', message=FALSE, error=FALSE, cache=TRUE}
...
```{r data, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r transportation, message=FALSE, warning=FALSE, results='hide', cache=TRUE}
...
```{r trans visualization, message=FALSE, warning=FALSE, cache=TRUE}
...
```{r restaurant data, warning=FALSE, message=FALSE, cache=TRUE}
...
```{r corr-rest-litter, warning=FALSE, message=FALSE, cache=TRUE}
corr_net <- rstrt_net %>%
  left_join(litter_no, by = "uniqueID")
...
```{r water data, warning=FALSE, message=FALSE, cache=TRUE}
...
```{r water visualization, warning=FALSE, cache=TRUE}
...
```{r waste data, warning=FALSE, message=FALSE, cache=TRUE}
...
```{r waste visualization, warning=FALSE, message=FALSE, cache=TRUE}
...
```{r function trial, warning=FALSE, message=FALSE, results='hide', cache=TRUE}
...
```{r eval=FALSE, include=FALSE, message=FALSE, cache=TRUE}
grid.arrange(
ggplot() +
...
```{r message=FALSE, warning=FALSE, results='hide', eval=FALSE, cache=TRUE}
