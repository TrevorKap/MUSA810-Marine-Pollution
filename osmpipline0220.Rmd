...
In light of the inherent bias stemmed from litter data, we also are developing a 'Reduced Bias' Model in attempt to compensate for potential  assumptions made by the model in terms of quanity. 
...
### Statistic Analysis with restaurants...again? 
...
After a full analysis on variables, model development, and statistical evaluation of all relations, we developed a risk assessment model. 
