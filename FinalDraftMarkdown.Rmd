...
```{r loading other nets}
net_salvador <- st_read('https://raw.githubusercontent.com/TrevorKap/MUSA810-Marine-Pollution/main/Data/stored_city/salvador_net.geojson')
...
city_names <- c("santa_fe", "semarang", "panama", "can_tho", "malaka", 
                "surat", "santiago", "bangkok", "chen", "mumbai", "pune")
city_data <- list()
...
The following comparative model visaulizes the strength of the model as it is used across cities.
