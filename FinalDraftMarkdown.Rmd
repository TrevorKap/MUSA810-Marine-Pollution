...
This project was completed for the MUSA/Smart Cities Practicum course (MUSA 790) instructed by Michael Fichman and Matthew Harris. We are grateful to our instructors for their continued support and feedback. We are also grateful to our client Daniel Sebastian Padilla Ochoa from Ocean Conservancy for his guidance and support throughout this practicum project.

# Introduction

## Abstract

Marine litter  continues to pose as a major threat to people, animals, and the environment. While zero-waste pilot programs like Ocean Conservancy’s Urban Ocean have made strides, there often exists a difficulty in site-selection of pilots due to lacking litter information. This adds unnecessary barriers to the siting of pilot zero-waste pickup programs. By leveraging geospatial machine learning, this project seeks to explore how best to navigate zero-waste siting in areas facing bleak marine litter conditions.

## Client Background

![Project Partners. Source: Ocean Conservancy](partners.png) ![Source: The Independent](mumbai.png)
...
Our resulting dashboard is to support the narrative-building and decision-making of zero-waste pilot siting and attract funding sources for cities. Main funding partners include private corporates, foundations, and federal departments
...
Our primary dataset focused on existing marine debris/litter from the [Marine Debris Tracker](https://www.debristracker.org/data/) powered by Morgan Stanley in collaboration with the National Geographic Society and the University of Georgia. The Marine Debris Tracker is a web-application and public use database that tracks user-recorded global litter pick-up projects and initiatives from participating organizations.
...
![WILL REPLACE](variablesdraft.png)
