...
```{r data loading, warning = FALSE, message = FALSE, cache = TRUE, hide = TRUE}
...
```{r loading other nets, warning = FALSE, message = FALSE, cache = TRUE, hide = TRUE}
...
# Second grid.arrange with 6 plots in the second row
