...
This project was completed for the MUSA/Smart Cities Practicum course (MUSA 801) instructed by Michael Fichman and Matthew Harris. We are grateful to our instructors for their continued support and feedback. We are also grateful to our client Daniel Sebastian Padilla Ochoa from Ocean Conservancy for his guidance and support throughout this practicum.

# Introduction

## Abstract

How best? By leveraging geospatial machine learning, this project seeks to explore how best to navigate zero-waste siting in areas facing bleak marine litter conditions.

## Background

![Project Partners. Source: Ocean Conservancy](partners.png)
...
We based our focus on various cities from the Urban Ocean program. The Resilient Cities Network is a coalition of cities around the world that assist one another in building safer, more sustainable, and equitable futures for their populations. Each of which shares their knowledge, experiences, and policy practices to empower one another. The 12 participating cities a part of the Urban Ocean program as of May 2024 are: <font size="4"> 
...
plotTheme <- function(base_size = 10, title_size = 14) {
  theme(
    ...
    plot.caption = element_text(hjust = 0, family = "Avenir"),
    axis.ticks = element_blank(),
    panel.grid.major = element_line("white", size = 0.1),
    panel.grid.minor = element_blank(),
